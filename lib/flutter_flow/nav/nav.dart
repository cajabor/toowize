        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'createPage')
                  : const NavBarPage(
                      initialPage: 'createPage',
                      page: CreatePageWidget(),
                    ),
            ),
            FFRoute(
              name: 'QOTD',
              path: 'qotd',
              requireAuth: true,
              builder: (context, params) => const QotdWidget(),
            ),
            FFRoute(
              name: 'quoteDetailPage',
              path: 'quote/:quoteRef',
              requireAuth: true,
              builder: (context, params) => QuoteDetailPageWidget(
                quoteRef: params.getParam(
                  'quoteRef',
                  ParamType.DocumentReference,
                  isList: false,
                  collectionNamePath: ['quotes'],
                ),
                parentPage: params.getParam(
                  'parentPage',
                  ParamType.String,
                ),
              ),
            ...
            FFRoute(
              name: 'setDisplayNamePic',
              path: 'setDisplayNamePic',
              requireAuth: true,
              builder: (context, params) => const SetDisplayNamePicWidget(),
            ),
            FFRoute(
              name: 'authPage',
              path: 'authPage',
            ...
            FFRoute(
              ...
              path: 'myFollowers',
              requireAuth: true,
              builder: (context, params) => const MyFollowersWidget(),
            ),
            FFRoute(
              name: 'userDetailFollowers',
              path: 'userDetailFollowers',
              requireAuth: true,
              builder: (context, params) => UserDetailFollowersWidget(
                userDetailRef: params.getParam(
                  'userDetailRef',
                  ParamType.DocumentReference,
                  isList: false,
                  collectionNamePath: ['users'],
                ),
                userDisplayName: params.getParam(
                  'userDisplayName',
                  ParamType.String,
                ),
              ),
            ...
            FFRoute(
              ...
              path: 'userDetailFollowing',
              requireAuth: true,
              asyncParams: {
                'userDoc': getDoc(['users'], UsersRecord.fromSnapshot),
              },
              builder: (context, params) => UserDetailFollowingWidget(
            ...
            FFRoute(
              ...
              path: 'likedQuotes',
              requireAuth: true,
              builder: (context, params) => const LikedQuotesWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => const SuggestionsPageWidget(),
            ),
            FFRoute(
              name: 'Donate',
              path: 'donate',
            ...
            FFRoute(
              ...
              path: 'myFollowing',
              requireAuth: true,
              builder: (context, params) => const MyFollowingWidget(),
            )
